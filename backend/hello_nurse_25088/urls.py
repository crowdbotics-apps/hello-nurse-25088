"""hello_nurse_25088 URL Configuration
...
admin.site.site_header = "Hello Nurse"
admin.site.site_title = "Hello Nurse Admin Portal"
admin.site.index_title = "Hello Nurse Admin"

# swagger
api_info = openapi.Info(
    title="Hello Nurse API",
    default_version="v1",
    description="API documentation for Hello Nurse App",
)
